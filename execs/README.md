...
The following tools for z/VM are in this repository: 
    ...
    | WHOG     EXEC    | Show logged on users in groups                  |
    +------------------+-------------------------------------------------+
## Installation
...
### WHOG EXEC
The ``WHOG EXEC`` takes the output of ``QUERY NAMES``, shows it in logical groups. It also allows for a search pattern. 
 
In order for it to determine virtual machines running Linux, the relatively new ``SCPID`` command must be available.

Here is an example of using it:

```
whog           
Admins:    MIKEMAC NEALE                                                  
DirMaint:                                                                 
Linux:     WARNING: SCPID command not found                               
SFS:       VMSERVP VMSERVR VMSERVS VMSERVU                                
SMAPI:     DTCSMAPI PERSMAPI VSMEVSRV VSMGUARD VSMREQIN VSMREQIU VSMREQI6 
           VSMWORK1 VSMWORK2 VSMWORK3 VSM                                 
TCP/IP:    DTCVSW1 DTCVSW2 DTCVSW3 DTCVSW4 FTPSERVE PORTMAP SSLDCSSM      
           SSL00001 SSL00002 SSL00003 SSL00004 SSL00005 TCPIP             
Velocity:                                                                 
VM Secure: VMACCT VMARCH VMBACKUP VMBATCH VMSCHED VMSECURE VMSPOOL        
           VMTAPE                                                         
z/VM:      GCS GSKADMIN MAINT710 OPERATOR PERFSVM RSCS SMTP               
           SNMPD SNMPQE VMNFS                                             
SSI:                                                                      
Others:    BUILDBOT CASYS CONLOG CTS7XDEV FEDORA16 FPSRVT01 FPSRVU01      
           RHEL60 RHEL70 RHEL8 RSCSDNS SFSPOOL2 UCTOOLS VMX$0001          
           VMX$0002 VSEN63 ZLNX1 ZLNX2 ZOS25 ZVSE62                       
Total: 68                                                                 
```
